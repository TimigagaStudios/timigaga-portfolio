      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden text-white hover:text-[#95EF90] focus:outline-none p-2 transition-transform active:scale-95"
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 right-0 bottom-0 w-full bg-[#050505] z-[102] md:hidden flex flex-col p-6 overflow-y-auto"
            >
              <div className="flex items-start justify-between mb-12">
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="text-white/85 hover:text-[#95EF90] transition-colors mt-2"
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.name}
                      to={link.path}
                      className={`text-[1.7rem] leading-none tracking-[-0.04em] font-semibold transition-colors ${
